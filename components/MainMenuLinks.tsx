...
export default function MainMenuLinks() {
	const linkAndDescription = [[SiteMap.CREATE_BRAIN, "CREATE A BRAIN"], [SiteMap.FEED_BRAIN,"FEED A BRAIN"], [SiteMap.TALK_TO_A_BRAIN, "TALK TO A BRAIN"], [SiteMap.TUTORIAL, "TUTORIAL"]].map((x, y) =>  
			<a
				href={x[0]} 
				key={y} 
